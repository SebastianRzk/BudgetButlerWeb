...
pub fn map_to_template(view_result: AddDauerauftragViewResult) -> AddDauerauftragTemplate {
    AddDauerauftragTemplate {
        ...
        rhythmen: Select::new(vec![
            Rhythmus::Monatlich.to_german_string(),
            Rhythmus::Vierteljaehrlich.to_german_string(),
            Rhythmus::Halbjaehrlich.to_german_string(),
            Rhythmus::Jaehrlich.to_german_string(),
        ], Some(view_result.default_item.rhythmus.to_german_string())),
        typen: Select::new(vec![
            "Einnahme".to_string(),
            "Ausgabe".to_string(),
...
#[cfg(test)]
mod tests {
    use crate::budgetbutler::pages::einzelbuchungen::add_dauerauftrag::{AddDauerauftragViewResult, DefaultItem, LetzteErfassung};
    use crate::model::primitives::betrag::Betrag;
