...
use crate::io::html::views::templates::chart_templates::{
    map_buchung_kategorie, map_pie_chart, BarChartTemplate, BuchungKategorieTemplate,
    LineChartDataSetTemplate, LineChartTemplate, PieChartTemplate,
};
...
fn map_to_template(view_result: UebersichtJahrViewResult) -> UebersichtJahrTemplate {
    UebersichtJahrTemplate {
        ...
        durchschnittlich_monat: BarChartTemplate {
            labels: JSONStringList::new(view_result.durchschnittlich_monat.labels).to_string(),
            datasets: JSONBetragList::new(view_result.durchschnittlich_monat.datasets).to_string(),
        },
