...
fn map_to_template(view_result: GemeinsamAbrechnenViewResult) -> GemeinsamAbrechnenTemplate {
    GemeinsamAbrechnenTemplate {
        ...
        set_mindate: view_result.mindate.to_german_string(),
        set_mindate_rfc: view_result.mindate.to_iso_string(),
        set_maxdate: view_result.maxdate.to_german_string(),
        set_maxdate_rfc: view_result.maxdate.to_iso_string(),
