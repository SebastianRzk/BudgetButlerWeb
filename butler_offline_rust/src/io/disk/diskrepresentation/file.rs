...
pub const ORDER_HEADER: &str = "Datum,Name,Konto,Depotwert,Wert";

pub const DAUERAUFTRAG_ORDER_START_SIGNAL: &str = "Dauerauftr_Ordr";
pub const DAUERAUFTRAG_ORDER_HEADER: &str = "Startdatum,Endedatum,Rhythmus,Name,Konto,Depotwert,Wert";
