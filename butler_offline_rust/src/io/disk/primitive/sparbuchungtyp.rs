...
const VORABPAUSCHALE_STR: &str = "Vorabpauschale";
...
pub fn read_sparbuchungtyp(rhythmus: Element) -> SparbuchungTyp {
    match rhythmus.element.as_str() {
        ...
        VORABPAUSCHALE_STR => SparbuchungTyp::Vorabpauschale,
...
pub fn write_sparbuchungtyp(sparbuchung_typ: &SparbuchungTyp) -> Element {
    Element {
        element: match sparbuchung_typ {
            ...
            SparbuchungTyp::Vorabpauschale => VORABPAUSCHALE_STR.to_string(),
...
mod tests {
    ...
    fn test_read_sparbuchungtyp() {
        ...
        let vorabpauschale = element("Vorabpauschale");
        assert_eq!(
            read_sparbuchungtyp(vorabpauschale),
    ...
    fn test_write_sparbuchungtyp() {
        ...
        let vorabpauschale = write_sparbuchungtyp(&SparbuchungTyp::Vorabpauschale);
        assert_eq!(vorabpauschale.element, "Vorabpauschale");
