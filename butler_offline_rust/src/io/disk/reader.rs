...
pub fn read_database(config: &DatabaseConfiguration, current_database_version: DatabaseVersion) -> Database {
    let file = read_file(get_database_location(config));
...
2020-01-01,MeinName,MeinKonto,MeinDepotwert,4.00
2020-01-02,MeinName2,MeinKonto2,MeinDepotwert2,5.00

Dauerauftr_Ordr
Startdatum,Endedatum,Rhythmus,Name,Konto,Depotwert,Wert
2020-01-01,2021-01-02,monatlich,MeinName,MeinKonto,MeinDepotwert,4.00
2020-01-02,2021-01-03,monatlich,MeinName2,MeinKonto2,MeinDepotwert2,5.00
...
";
    ...
    fn test_read_data() {
        ...
        assert_eq!(erste_sparbuchung.wert, Betrag::new(Vorzeichen::Negativ, 123, 12));
        ...
        assert_eq!(zweite_sparbuchung.wert, Betrag::new(Vorzeichen::Negativ, 123, 13));
        ...
        assert_eq!(erste_order.wert, Betrag::new(Vorzeichen::Positiv, 4, 0));
        ...
        assert_eq!(zweite_order.wert, Betrag::new(Vorzeichen::Positiv, 5, 0));
        ...
        assert_eq!(erste_order_dauerauftrag.wert, Betrag::new(Vorzeichen::Positiv, 4, 0));
        ...
        assert_eq!(zweite_order_dauerauftrag.wert, Betrag::new(Vorzeichen::Positiv, 5, 0));
