...
pub fn handle_view(context: UebersichtGemeinsameBuchungenContext) -> UebersichtGemeinsameBuchungenViewResult {
...
mod tests {
    ...
    fn test_handle_view() {
        ...
        assert_eq!(result.liste[0].value, any_gemeinsame_buchung());
    }
