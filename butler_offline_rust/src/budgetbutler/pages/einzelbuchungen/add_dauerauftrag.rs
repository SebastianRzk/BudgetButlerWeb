...
mod tests {
    ...
    use crate::model::primitives::rhythmus::Rhythmus;
    use crate::model::state::non_persistent_application_state::DauerauftragChange;
    use crate::model::state::persistent_application_state::builder::{generate_database_with_dauerauftraege, generate_database_with_einzelbuchungen, generate_empty_database};
    ...
    pub fn test_handle_view_should_preset_changes() {
        ...
        assert_eq!(result.letzte_erfassungen[0].rhythmus, Rhythmus::Vierteljaehrlich);
