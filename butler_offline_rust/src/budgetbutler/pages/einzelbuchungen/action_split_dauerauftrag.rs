...
pub fn submit_split_dauerauftrag(context: ActionSplitDauerauftragContext) -> RedirectResult<DauerauftragChange> {
    ...
    let mut neue_dauerauftraege = context.database.dauerauftraege.change().edit(context.dauerauftrag_id, geaenderter_dauerauftrag);
