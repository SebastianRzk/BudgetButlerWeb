...
mod tests {
    ...
    fn test_handle_uebersicht_kontos_empty() {
        ...
        assert_eq!(result.konten[0].konto.value, any_konto());
    ...
    fn test_handle_uebersicht(){
        ...
        vec![sparbuchung_with_betrag_typ_und_konto(zwei(), SparbuchungTyp::ManuelleEinzahlung, any_konto().as_reference())]
        );
        let context = super::UebersichtKontosContext {
            database: &database,
        };
