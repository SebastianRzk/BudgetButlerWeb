...
pub fn sparen_menu() -> RootMenu {
    RootMenu {
        ...
        sub_menu: vec![
            ...
            MenuEntry {
                url: SPAREN_DEPOTWERT_UEBERSICHT.to_string(),
