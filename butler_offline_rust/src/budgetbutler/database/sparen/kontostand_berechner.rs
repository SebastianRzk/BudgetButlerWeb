        ...
        .collect()
    {
        match sparbuchung.value.typ {
            SparbuchungTyp::ManuelleEinzahlung => {
                letzter_kontostand = letzter_kontostand + sparbuchung.value.wert;
            }
...
fn berechne_einzahlungen(konto: Sparkonto, database: &Database) -> Betrag {
        ...
        .collect()
    {
        match sparbuchung.value.typ {
            SparbuchungTyp::ManuelleEinzahlung => {
                gesamte_einzahlungen = gesamte_einzahlungen + sparbuchung.value.wert;
            }
            SparbuchungTyp::ManuelleAuszahlung => {
                gesamte_einzahlungen = gesamte_einzahlungen - sparbuchung.value.wert;
            }
    ...
    for order in database
        ...
        .collect()
    {
        gesamte_einzahlungen = gesamte_einzahlungen + order.value.wert;
    }
...
mod tests_fuer_depot {
    ...
    use crate::model::database::depotwert::builder::any_depotwert_referenz;
    ...
    use crate::model::database::sparbuchung::SparbuchungTyp;
    use crate::model::database::sparkonto::builder::{any_konto, any_konto_with_typ};
    ...
    #[test]
    fn test_berechne_kontostand_fuer_depot_sollte_sparbuchungen_vorabpauschale_beruecksichtigen() {
        let database =
            generate_database_with_sparbuchungen(vec![sparbuchung_with_betrag_typ_und_konto(
                zwei(),
                SparbuchungTyp::Vorabpauschale,
...
mod tests_fuer_sparkonto {
    ...
    #[test]
    fn test_berechne_kontostand_sollte_sparbuchungen_vorabpauschale_beruecksichtigen() {
        let database =
            generate_database_with_sparbuchungen(vec![sparbuchung_with_betrag_typ_und_konto(
                zwei(),
                SparbuchungTyp::Vorabpauschale,
