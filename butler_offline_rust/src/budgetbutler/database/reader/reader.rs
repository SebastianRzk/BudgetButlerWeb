    ...
    for sparbuchung in &database.sparbuchungen.sparbuchungen {
        ...
        match sparbuchung.value.typ {
            ...
            SparbuchungTyp::ManuelleAuszahlung | SparbuchungTyp::Ausschuettung => {
                betrag = sparbuchung.value.wert.clone();
            }
    ...
    for order in &order {
        ...
        einzelbuchungen.push(Indiziert {
            ...
            value: Einzelbuchung {
                ...
                kategorie: Kategorie::new(SPAREN_KATEGORIE.to_string()),
                betrag: order.value.wert.invertiere_vorzeichen(),
            },
        });
    }
...
mod tests {
    ...
    use crate::model::database::depotauszug::builder::any_depotauszug;
    ...
    use crate::model::primitives::datum::Datum;
    use crate::model::primitives::kategorie::builder::{any_kategorie, sparen_kategorie};
    ...
    {
        let sparbuchung =
            sparbuchung_with_betrag_und_typ(zwei(), SparbuchungTyp::ManuelleEinzahlung);
        let data_on_disk = data_on_disk_with_sparbuchungen(vec![sparbuchung.clone()]);
    ...
    {
        let sparbuchung =
            sparbuchung_with_betrag_und_typ(zwei(), SparbuchungTyp::ManuelleAuszahlung);
        let data_on_disk = data_on_disk_with_sparbuchungen(vec![sparbuchung.clone()]);
    ...
    fn test_should_calc_sparbuchungen_to_einzelbuchungen_with_ausschuettung_should_import_as_einnahme(
        ...
        let sparbuchung = sparbuchung_with_betrag_und_typ(zwei(), SparbuchungTyp::Ausschuettung);
        let data_on_disk = data_on_disk_with_sparbuchungen(vec![sparbuchung.clone()]);
    ...
    fn test_should_calc_sparbuchungen_to_einzelbuchungen_with_zinsen_should_do_nothing() {
        let sparbuchung = sparbuchung_with_betrag_und_typ(zwei(), SparbuchungTyp::Zinsen);
        let data_on_disk = data_on_disk_with_sparbuchungen(vec![sparbuchung.clone()]);
    ...
    #[test]
    fn test_should_calc_sparbuchungen_to_einzelbuchungen_with_vorabpauschale_should_import_as_ausgabe(
    ) {
        let sparbuchung = sparbuchung_with_betrag_und_typ(zwei(), SparbuchungTyp::Vorabpauschale);
        let data_on_disk = data_on_disk_with_sparbuchungen(vec![sparbuchung.clone()]);
    ...
    fn test_should_calc_sparbuchungen_to_einzelbuchungen_with_sonstige_kosten_should_import_as_ausgabe(
        ...
        let sparbuchung = sparbuchung_with_betrag_und_typ(zwei(), SparbuchungTyp::SonstigeKosten);
        let data_on_disk = data_on_disk_with_sparbuchungen(vec![sparbuchung.clone()]);
    ...
    fn test_init_order_should_create_einzelbuchung() {
        ...
        assert_eq!(
            ...
            Einzelbuchung {
                ...
                betrag: order.wert.invertiere_vorzeichen(),
            }
        );
    }
    ...
    fn test_init_order_dauerauftraege_should_create_einzelbuchung() {
        ...
        assert_eq!(
            ...
            Einzelbuchung {
                ...
                kategorie: sparen_kategorie(),
                betrag: order_dauerauftrag.wert.invertiere_vorzeichen(),
            }
        );
    }
    ...
    fn test_should_init_depotauszuege() {
        let depotauszug = any_depotauszug();
