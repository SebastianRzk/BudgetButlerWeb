...
@Component({
  ...
  imports: [MatCard, MatCardHeader, MatCardTitle, MatCardContent, FormsModule, ReactiveFormsModule, MatFormField, MatLabel, MatInput, MatButton, MatTable, MatColumnDef, MatHeaderCell, MatCell, MatIcon, MatHeaderRow, MatRow]
})
