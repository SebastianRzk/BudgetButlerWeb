...
export class EinzelbuchungUebersichtService {
  ...
  public readonly einzelbuchungenUebersicht$ = this.einzelbuchungenUebersicht.asObservable();


  public refresh(): void {
    firstValueFrom(this.httpClient.get<BuchungsUebersichtTO>(this.api.getUrl('einzelbuchungen_uebersicht')).pipe(map(x => toBuchungsUebersicht(x)))).then(
