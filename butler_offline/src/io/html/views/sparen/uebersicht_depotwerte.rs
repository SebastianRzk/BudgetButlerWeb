...
pub fn render_uebersicht_depotwerte_template(view_result: UebersichtDepotwerteViewResult) -> String {
...
pub fn map_to_template(view_result: UebersichtDepotwerteViewResult) -> UebersichtKontoTemplate {
    UebersichtKontoTemplate {
        ...
        depotwerte: view_result.depotwerte.iter().map(|depotwert| {
            DepotwerteTemplate {
                index: depotwert.depotwert.index,
                name: depotwert.depotwert.value.name.name.clone(),
                typ: write_depotwerttyp(depotwert.depotwert.value.typ.clone()).element.clone(),
