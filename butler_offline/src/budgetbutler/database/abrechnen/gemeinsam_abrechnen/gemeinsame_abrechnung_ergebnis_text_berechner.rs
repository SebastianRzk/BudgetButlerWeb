...
mod tests {
    ...
    fn test_kein_limit_50_50_self_mehr_ausgegeben() {
        let ergebnis = berechne_ergebnis_text(
            ...
            person("IchName"),
            person("PartnerName"),
            Datum::from_iso_string("2020-10-10"),
            Datum::from_iso_string("2020-12-12"),
            10,
            Betrag::from_user_input("-100"),
            None,
            &GemeinsamAbrechnenVerhaeltnis {
                eigenes: PersonenVerhaeltnis {
                    soll: Betrag::from_user_input("50"),
                    ist: Betrag::from_user_input("60"),
                    diff: Betrag::from_user_input("10"),
                },
                partner: PersonenVerhaeltnis {
                    soll: Betrag::from_user_input("50"),
                    ist: Betrag::from_user_input("40"),
                    diff: Betrag::from_user_input("-10"),
                },
                modus: KeinLimit,
            },
    ...
    fn test_limit_unterschritten_50_50_partner_mehr_ausgegeben() {
        let ergebnis = berechne_ergebnis_text(
            ...
            Some(Limit {
                ...
                value: Betrag::from_user_input("200"),
            }),
            &GemeinsamAbrechnenVerhaeltnis {
                eigenes: PersonenVerhaeltnis {
                    soll: Betrag::from_user_input("50"),
    ...
    fn test_limit_ueberschritten_50_50_partner_mehr_ausgegeben() {
        let ergebnis = berechne_ergebnis_text(
            ...
            Some(Limit {
                fuer: person("PartnerName"),
                value: Betrag::from_user_input("40"),
            }),
            &GemeinsamAbrechnenVerhaeltnis {
                eigenes: PersonenVerhaeltnis {
                    soll: Betrag::from_user_input("60"),
                    ist: Betrag::from_user_input("40"),
                    diff: Betrag::from_user_input("-20"),
                },
                partner: PersonenVerhaeltnis {
                    soll: Betrag::from_user_input("40"),
                    ist: Betrag::from_user_input("60"),
                    diff: Betrag::from_user_input("20"),
                },
                modus: LimitErreicht,
