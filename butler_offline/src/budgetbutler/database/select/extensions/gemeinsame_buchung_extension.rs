...
mod tests {
    ...
    fn test_rename_person() {
        let gemeinsame_buchungen = GemeinsameBuchungen {
            gemeinsame_buchungen: vec![
                indiziert(demo_gemeinsame_buchung()),
            ],
        };
        ...
        assert_eq!(result.gemeinsame_buchungen[0].value.person, person("neuer name"));
    }
    ...
    fn test_rename_kategorie() {
        ...
        assert_eq!(result.gemeinsame_buchungen[0].value.kategorie, kategorie("neue kategorie"));
    }
}