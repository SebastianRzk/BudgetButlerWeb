...
pub fn action_change_ausgeschlossene_kategorien(context: ChangeAusgeschlosseneKategorienContext) -> ChangeConfigViewResult {
...
mod tests {
    ...
    fn test_action_change_ausgeschlossene_kategorien() {
        ...
        assert_eq!(
            result.new_config.erfassungs_configuration.ausgeschlossene_kategorien,
            vec![kategorie("asdf")]
        );
    }
}
