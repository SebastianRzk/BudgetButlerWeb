...
def teste__context_values__with_mutlible_einnahme_and_ausgabe():
    ...
    assert result_context['zusammenfassung_ausgaben'] == [['some kategorie', '-200.00', '#00a65a'],
                                                          ['some kategorie2', '-100.00', '#00c0ef']]
    assert result_context['zusammenfassung_einnahmen'] == [['eine einnahme kategorie', '20.00', '#3c8dbc'],
