...
class OrderDauerauftragTest(unittest.TestCase):
    ...
    def test_order_until_today_with_invalid_dates_should_be_empty(self):
        component_under_test = OrderDauerauftrag()
    ...
    def test_order_until_today_with_date_in_future_should_be_empty(self):
        component_under_test = OrderDauerauftrag()
    ...
    def test_order_until_today(self):
        component_under_test = OrderDauerauftrag()
    ...
    def test_order_until_today_table_header_should_comply_order_table_header(self):
        component_under_test = OrderDauerauftrag()
